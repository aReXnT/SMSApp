package com.example.arexnt.ExSMS.common.formatter;


import android.content.Context;
import android.telephony.TelephonyManager;

import com.example.arexnt.ExSMS.SMSAppBase;
...
public class NumberToContactFormatter implements Formatter {
    ...
    public String getCurrentCountryIso() {
        if (mCountryIso == null) {
            TelephonyManager tm = (TelephonyManager) SMSAppBase.getApplication().getSystemService(Context.TELEPHONY_SERVICE);
