package com.example.arexnt.ExSMS.common.utils;
...
import com.example.arexnt.ExSMS.SMSApp;
...
/**
 * Created by arexnt on 2017/4/12.
 */
...
public class DateFormatter {
    ...
    public static String getRelativeTimestamp(long date) {
        ...
        if (relativeTimestamp.equals("in 0 minutes") || relativeTimestamp.equals("0 minutes ago"))
            return SMSApp.getApplication().getString(R.string.date_just_now);
