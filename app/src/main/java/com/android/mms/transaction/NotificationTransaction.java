...
import com.android.mms.pdu_alt.GenericPdu;
import com.android.mms.pdu_alt.NotificationInd;
import com.android.mms.pdu_alt.NotifyRespInd;
import com.android.mms.pdu_alt.PduComposer;
import com.android.mms.pdu_alt.PduHeaders;
import com.android.mms.pdu_alt.PduParser;
import com.android.mms.pdu_alt.PduPersister;
import com.android.mms.util.DownloadManager;
import com.example.arexnt.ExSMS.MmsConfig;

import java.io.IOException;

import static com.android.mms.pdu_alt.PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF;
import static com.android.mms.pdu_alt.PduHeaders.STATUS_DEFERRED;
import static com.android.mms.pdu_alt.PduHeaders.STATUS_RETRIEVED;
import static com.android.mms.pdu_alt.PduHeaders.STATUS_UNRECOGNIZED;
...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public NotificationTransaction(
        ...
        try {
            ...
            try {
                group = com.example.arexnt.ExSMS.mmssms.Transaction.settings.getGroup();
            } catch (Exception e) {
            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, Inbox.CONTENT_URI, true,
                            com.example.arexnt.ExSMS.mmssms.Transaction.settings.getGroup(), null);
                    ...
                    mContext.sendBroadcast(new Intent(com.example.arexnt.ExSMS.mmssms.Transaction.NOTIFY_OF_MMS));
                }
            }
